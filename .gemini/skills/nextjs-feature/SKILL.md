...
Build a feature the headlessengineer way. Follows `.gemini/rules/nextjs.md`.
...
5. Styling via design tokens only (see `component-build` and `.gemini/rules/styling.md`).
